...
@Component({
  selector: 'app-trade-seller',
  templateUrl: './trade-seller.component.html',
  styleUrls: ['./trade-seller.component.scss']
})

export class TradeSellerComponent implements OnInit, OnDestroy {
  accounts: string[];
  MetaCoin: any;
...
/*
   public getContract(): Observable<any> {
